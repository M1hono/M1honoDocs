...
export class SimpleDocumentGenerator {
    ...
    async generateDocumentation(): Promise<ProjectDocIndex> {
        ...
        console.log(
            `✅ 生成完成: ${testClasses.length} 个类, ${docIndex.packages.size} 个包`
        );
        return docIndex;
    }
                ...
                this.createClass(
                    ...
                    [
                        ...
                        },
                        {
                            name: "version",
                            type: "int",
                            comment: "The version of the agent",
                        },
                    ],
                    [
                        {
                            name: "getName",
                            returnType: "String",
                            comment: "Gets the agent name",
                        },
                        {
                            name: "getVersion",
                            returnType: "int",
                            comment: "Gets the agent version",
                        },
                        {
                            name: "toString",
                            returnType: "String",
                    ...
                    [
                        {
                            ...
                            comment: "Authenticates a user with credentials",
                        },
                        {
                            name: "refresh",
                            returnType: "boolean",
                            comment: "Refreshes authentication token",
                        },
                        {
                            name: "validate",
                            returnType: "boolean",
                            comment: "Validates current authentication",
                        },
                    ]
                ),
                    ...
                    [
                        {
                            name: "agent",
                            type: "Agent",
                            comment: "The authentication agent",
                        },
                        {
                            name: "proxy",
                            type: "Proxy",
                    ...
                    [
                        {
                            name: "getAgent",
                            returnType: "Agent",
                            comment: "Gets the authentication agent",
                        },
                        {
                            name: "setProxy",
                            returnType: "void",
                            comment: "Sets the network proxy",
                        },
                        {
                            name: "createRequest",
                            returnType: "HttpRequest",
                            comment: "Creates HTTP request",
                        },
                    ],
                    "AuthenticationService"
                ),
                    ...
                    [
                        {
                            name: "initialized",
                            type: "boolean",
                            comment: "Whether the engine is initialized",
                        },
                        {
                            name: "glVersion",
                            type: "String",
                            comment: "OpenGL version string",
                        },
                    ],
                    [
                        {
                            name: "init",
                            returnType: "void",
                            comment: "Initializes the Blaze3D engine",
                        },
                        {
                            name: "shutdown",
                            returnType: "void",
                            comment: "Shuts down the engine",
                        },
                        {
                            name: "render",
                            returnType: "void",
                            comment: "Renders the current frame",
                        },
                    ]
                ),
                    ...
                    [
                        {
                            name: "bind",
                            returnType: "void",
                            comment: "Binds the vertex buffer",
                        },
                        {
                            name: "upload",
                            returnType: "void",
                            comment: "Uploads vertex data to GPU",
                        },
                        {
                            name: "draw",
                            returnType: "void",
                            comment: "Draws the vertices",
                        },
                    ]
                ),
            ]
                ...
                this.createClass(
                    ...
                    [
                        ...
                        },
                        {
                            name: "running",
                            type: "boolean",
                            comment: "Whether the game is running",
                        },
                        {
                            name: "gameSettings",
                            type: "GameSettings",
                    ...
                    [
                        {
                            name: "getInstance",
                            returnType: "Minecraft",
                            comment: "Gets the singleton instance",
                        },
                        {
                            name: "run",
                            returnType: "void",
                        ...
                        },
                        {
                            name: "shutdown",
                            returnType: "void",
                            comment: "Shuts down the game",
                        },
                        {
                            name: "tick",
                            returnType: "void",
                            comment: "Updates game logic",
                        },
                    ]
                ),
                    ...
                    [
                        {
                            name: "name",
                            type: "String",
                            comment: "Key binding name",
                        },
                        {
                            name: "keyCode",
                            type: "int",
                            comment: "Keyboard key code",
                        },
                        {
                            name: "category",
                            type: "String",
                            comment: "Key binding category",
                        },
                    ],
                    [
                        {
                            name: "isDown",
                            returnType: "boolean",
                            comment: "Checks if key is pressed",
                        },
                        {
                            name: "setKey",
                            returnType: "void",
                            comment: "Sets the key code",
                        },
                        {
                            name: "getDisplayName",
                            returnType: "String",
                            comment: "Gets display name",
                        },
                    ]
                ),
                    ...
                    [
                        {
                            name: "random",
                            type: "Random",
                            comment: "World random generator",
                        },
                        {
                            name: "isClientSide",
                            type: "boolean",
                            comment: "True if client-side world",
                        },
                        {
                            name: "entities",
                            type: "List<Entity>",
                            comment: "All entities in world",
                        },
                    ],
                    [
                        {
                            name: "getBlock",
                            returnType: "Block",
                            comment: "Gets block at position",
                        },
                        {
                            name: "setBlock",
                            returnType: "boolean",
                            comment: "Sets block at position",
                        },
                        {
                            name: "addEntity",
                            returnType: "boolean",
                            comment: "Adds entity to world",
                        },
                        {
                            name: "tick",
                            returnType: "void",
                            comment: "Updates world logic",
                        },
                    ]
                ),
            ]
                    ...
                    [
                        {
                            name: "CLIENT",
                            type: "ClientConfig",
                            comment: "Client-side configuration",
                        },
                        {
                            name: "SERVER",
                            type: "ServerConfig",
                            comment: "Server-side configuration",
                        },
                        {
                            name: "COMMON",
                            type: "CommonConfig",
                    ...
                    [
                        {
                            name: "load",
                            returnType: "void",
                            comment: "Loads configuration from file",
                        },
                        {
                            name: "save",
                            returnType: "void",
                            comment: "Saves configuration to file",
                        },
                        {
                            name: "reload",
                            returnType: "void",
                            comment: "Reloads configuration",
                        },
                    ]
                ),
                    ...
                    [
                        {
                            ...
                            comment: "List of loaded mods",
                        },
                        {
                            name: "loadingState",
                            type: "LoadingState",
                            comment: "Current loading state",
                        },
                    ],
                    [
                        {
                            name: "loadMods",
                            returnType: "void",
                            comment: "Loads all discovered mods",
                        },
                        {
                            name: "getMod",
                            returnType: "ModContainer",
                            comment: "Gets mod by ID",
                        },
                        {
                            name: "isModLoaded",
                            returnType: "boolean",
                            comment: "Checks if mod is loaded",
                        },
                    ]
                ),
                    ...
                    [
                        {
                            name: "cancelled",
                            type: "boolean",
                            comment: "Whether event is cancelled",
                        },
                        {
                            name: "phase",
                            type: "EventPhase",
                            comment: "Event execution phase",
                        },
                    ],
                    [
                        {
                            name: "isCancelled",
                            returnType: "boolean",
                            comment: "Checks if event is cancelled",
                        },
                        {
                            name: "setCancelled",
                            returnType: "void",
                            comment: "Sets event cancellation",
                        },
                        {
                            name: "getPhase",
                            returnType: "EventPhase",
                            comment: "Gets event phase",
                        },
                    ]
                ),
            ]
            ...
            ...[
                ...
                this.createClass(
                    ...
                    [
                        {
                            name: "use",
                            returnType: "InteractionResult",
                            comment: "Called when item is used",
                        },
                    ]
                ),
                    ...
                    [
                        {
                            name: "onPlace",
                            returnType: "void",
                            comment: "Called when block is placed",
                        },
                    ]
                ),
            ]
