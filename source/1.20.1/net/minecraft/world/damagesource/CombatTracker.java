...
public class CombatTracker {
   ...
   public static final Style INTENTIONAL_GAME_DESIGN_STYLE = Style.EMPTY.withClickEvent(new ClickEvent(ClickEvent.Action.OPEN_URL, "https://bugs.mojang.com/browse/MCPE-28723")).withHoverEvent(new HoverEvent(HoverEvent.Action.SHOW_TEXT, Component.literal("MCPE-28723")));
   ...
   public Component getDeathMessage() {
      if (this.entries.isEmpty()) {
         ...
         if (true) {
             return deathmessagetype.getMessageFunction().getDeathMessage(mob, combatentry, combatentry1);
         }
